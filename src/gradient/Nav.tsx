  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-4">
        ...
        <a href="#contact" className="btn-nav inline-flex items-center gap-2 text-[11px] px-3 py-1.5 sm:text-[13px] sm:px-4 sm:py-2">
          Hire Me <ArrowRight size={14} className="hidden sm:block" />
        </a>
      </div>
    </motion.nav>
  );
