      ...
      >
        ...
        <motion.div variants={fadeIn} className="flex justify-center mb-8">
          <div className="badge-hero">
            <div className="w-6 h-6 rounded-full overflow-hidden border border-[var(--panel-border)] mr-2">
        ...
        {/* Main Title */}
        <motion.h1 variants={fadeIn} className="text-[clamp(2.5rem,7vw,6.5rem)] leading-[1.0] font-medium tracking-[-0.03em] mb-6 text-[var(--text-main)] drop-shadow-sm">
